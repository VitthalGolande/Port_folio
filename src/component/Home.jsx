  ...
  return (
    <div className=' bg-black text-white text-center py-16'>
        ...
        <h1 className='font-bold text-4xl'> 
            I'm {" "}
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>Golande Vitthal</span>
            , Full Stack Developer
        </h1>
        <p className='mt-4 text-lg text-gray-300 px-4 md:px-32'> I specialize in building modern and responsive web applications</p>
